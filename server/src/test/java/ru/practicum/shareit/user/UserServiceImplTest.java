...
class UserServiceImplTest {
    ...
    void getAllUsers_shouldReturnListUsers() {
        ...
        assertThat(userService.getAllUsers().get(0).getId(), equalTo(user.getId()));
    }
    ...
    void getUserById_shouldReturnUser() {
        ...
        assertThat(UserMapper.mapToUser(userService.getUserById(1)).getEmail(), equalTo(user.getEmail()));
        assertThat(UserMapper.mapToUser(userService.getUserById(1)).getId(), equalTo(user.getId()));
        assertThat(UserMapper.mapToUser(userService.getUserById(1)).getName(), equalTo(user.getName()));
    }
    ...
    void editUser_shouldReturnNewUser() {
        ...
        assertThat(UserMapper.mapToUser(userService.editUser(1, dto)).getId(), equalTo(user.getId()));
        assertThat(UserMapper.mapToUser(userService.editUser(1, dto)).getEmail(), equalTo(user.getEmail()));
        assertThat(UserMapper.mapToUser(userService.editUser(1, dto)).getName(), equalTo(user.getName()));
    }
    ...
    void saveUser_shouldReturnUser() {
        ...
        assertThat(UserMapper.mapToUser(userService.saveUser(dto)).getEmail(), equalTo(user.getEmail()));
        assertThat(UserMapper.mapToUser(userService.saveUser(dto)).getId(), equalTo(user.getId()));
        assertThat(UserMapper.mapToUser(userService.saveUser(dto)).getName(), equalTo(user.getName()));
    }
}